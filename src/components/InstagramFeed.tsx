...
export default function InstagramFeed() {
  useEffect(() => {
    ...
    return () => {
      // Clean up script if needed, though usually it's fine to leave it
  ...
  return (
    <div className="flex justify-center w-full overflow-hidden rounded-3xl shadow-2xl border border-[#1a1a1a]/5 bg-white p-4 md:p-8">
      <blockquote 
        className="instagram-media" 
        data-instgrm-permalink="https://www.instagram.com/rini_eyebrow_threading/?utm_source=ig_embed&amp;utm_campaign=loading" 
      ...
      >
        <div style={{ padding: '16px' }}>
          <a 
            href="https://www.instagram.com/rini_eyebrow_threading/?utm_source=ig_embed&amp;utm_campaign=loading" 
          ...
          <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            <a href="https://www.instagram.com/rini_eyebrow_threading/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">Rini (Owner)</a> (@<a href="https://www.instagram.com/rini_eyebrow_threading/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">rini_eyebrow_threading</a>) • Instagram photos and videos
          </p>
        </div>
      </blockquote>
    </div>
